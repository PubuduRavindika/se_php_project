...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2023 at 09:35 PM
...
(192054, 'Malith Jayasuriya', '123456'),
(192116, 'Pubudu Ravindika', '123456'),
(192141, 'Amandi Tharuka', '123456'),
(192153, 'Dulakshan Wijesundara', '123456');
...
--
ALTER TABLE `q_kit`
  MODIFY `q_kit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `q_kit_questions`
--
ALTER TABLE `q_kit_questions`
  MODIFY `q_kit_questions_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
